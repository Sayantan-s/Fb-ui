        ...
        <View as="figure" className="createpost">
            <View as="header" className="createpost_header">
                <Stack direction="h" className="createpost_header-btn">
                    <Button
                        moreClassName="createpost_header-btn--button active"
                        variant="transparent"
                        leftIcon={<Compose stroke={'#545455'} />}
                    >
                        Compose Post
                    </Button>
                    <Button
                        moreClassName="createpost_header-btn--button"
                        variant="transparent"
                        leftIcon={<Img stroke={'#545455'} />}
                    >
                        Photo/Video Album
                    </Button>
                    <Button
            ...
            <View className="createpost_write">
                ...
                <Input
                    ...
                    className={`createpost_write--input-${gifContext.gifurl ? 'small' : 'big'}`}
                />
            </View>
            ...
            {gifContext.gifurl && (
                <View className="createpost_media">
                    <Image
                        className="createpost_media--gif"
                        src={gifContext.gifurl}
                        alt="upload_img"
                    />
                </View>
            )}
            <Stack direction="h" className="createpost_gradients">
                ...
                {Array(8)
                    ...
                    .map((_, id) => (
                        <Image
                            src={`/gradients/${id + 1}.webp`}
                            alt={`gradient_${id + 1}`}
                            className="createpost_gradients--gradient"
                        />
                    ))}
            </Stack>
            <View className="createpost_activity">
                <View className="createpost_activity_stack">
                    <Button
                        moreClassName="createpost_activity_stack--button"
                        leftIcon={<TagFriends stroke="#839dcf" />}
                        variant="secondary"
                    >
                        Tag friends
                    </Button>
                    <Button
                        moreClassName="createpost_activity_stack--button"
                        leftIcon={<Checkin stroke="#BF4D7C" />}
                        variant="secondary"
                    >
                        Check in
                    </Button>
                ...
                <View className="createpost_activity_stack">
                    <Button
                        moreClassName="createpost_activity_stack--button"
                        leftIcon={<Gif stroke="#7B759D" />}
                        variant="secondary"
                        onClick={() =>
                            gifContext.setGifChoosingWidget(!gifContext.showGifChoosingWidget)
                        }
                    >
                        GIF
                    </Button>
                    <Button
                        moreClassName="createpost_activity_stack--button"
                        variant="secondary"
                        leftIcon={<TagEvents stroke="#BF4D7C" />}
                    >
                        Tag Event
                    </Button>
            ...
            <View className="createpost_footer" as="footer">
                <Stack direction="h" className="createpost_footer--box">
                    <Button
                        leftIcon={<Lock stroke={'#545455'} />}
                        rightIcon={
                            <Arrow
                                size={24}
                                stroke={'#545455'}
                                className="createpost_footer--box-righticon"
                            />
                        }
                    >
                        Only me
                    </Button>
                    <Button onClick={createNewPostHandler}>Post</Button>
                </Stack>
            </View>
        </View>
    );
